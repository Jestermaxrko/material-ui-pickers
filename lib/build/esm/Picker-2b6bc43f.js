...
import { a as arrayIncludes, V as VariantContext, u as useIsomorphicEffect, b as VIEW_HEIGHT, D as DIALOG_WIDTH, c as DIALOG_WIDTH_WIDER } from './Wrapper-a3384f6e.js';
import { a as Calendar } from './Calendar-99f49069.js';
...
var defProps = _objectSpread$1({}, datePickerDefaultProps, {
...
var Picker = function Picker(_ref) {
  var date = _ref.date,
      ...
      views = _ref$views === void 0 ? defProps.views : _ref$views,
      disableToolbar = _ref.disableToolbar,
      onChange = _ref.onChange,
      openTo = _ref.openTo,
      _ref$minDate = _ref.minDate,
      unparsedMinDate = _ref$minDate === void 0 ? defProps.minDate : _ref$minDate,
      _ref$maxDate = _ref.maxDate,
      unparsedMaxDate = _ref$maxDate === void 0 ? defProps.maxDate : _ref$maxDate,
      ToolbarComponent = _ref.ToolbarComponent,
      orientation = _ref.orientation,
      initialRest = _objectWithoutProperties(_ref, ["date", "views", "disableToolbar", "onChange", "openTo", "minDate", "maxDate", "ToolbarComponent", "orientation"]);

  var rest = _objectSpread$1({
    invalidDateMessage: 'Invalid Date Format',
    minDateMessage: 'Date should not be before minimal date',
    maxDateMessage: 'Date should not be after maximal date',
    allowKeyboardControl: true
...
//# sourceMappingURL=Picker-2b6bc43f.js.map
