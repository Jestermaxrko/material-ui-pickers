...
function makePickerWithState(_a) {
    var Input = _a.Input, useState = _a.useState, useOptions = _a.useOptions, getCustomProps = _a.getCustomProps, DefaultToolbarComponent = _a.DefaultToolbarComponent, defProps = _a.defProps;
    function PickerWithState(initialProps) {
        var props = __assign(__assign({}, defProps), initialProps);
