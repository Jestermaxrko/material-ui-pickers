...
var defProps = __assign(__assign({}, prop_types_1.datePickerDefaultProps), { views: Object.keys(viewsMap) });
exports.Picker = function (_a) {
    var _b, _c;
    var date = _a.date, _d = _a.views, views = _d === void 0 ? defProps.views : _d, disableToolbar = _a.disableToolbar, onChange = _a.onChange, openTo = _a.openTo, _e = _a.minDate, unparsedMinDate = _e === void 0 ? defProps.minDate : _e, _f = _a.maxDate, unparsedMaxDate = _f === void 0 ? defProps.maxDate : _f, ToolbarComponent = _a.ToolbarComponent, orientation = _a.orientation, initialRest = __rest(_a, ["date", "views", "disableToolbar", "onChange", "openTo", "minDate", "maxDate", "ToolbarComponent", "orientation"]);
    var rest = __assign({ invalidDateMessage: 'Invalid Date Format', minDateMessage: 'Date should not be before minimal date', maxDateMessage: 'Date should not be after maximal date', allowKeyboardControl: true }, initialRest);
    var utils = useUtils_1.useUtils();
    var classes = useStyles();
    var isLandscape = useIsLandscape_1.useIsLandscape(orientation);
    var _g = useViews_1.useViews(views, openTo, onChange), openView = _g.openView, setOpenView = _g.setOpenView, handleChangeAndOpenNext = _g.handleChangeAndOpenNext;
